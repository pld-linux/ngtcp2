...
# Source0-md5:	79a96d734a9c22f8dbd1cb371e70be69
...
BuildRequires:	xz
# for examples: libbrotli-devel >= 1.0.9, libev-devel, libstdc++-devel >= 6:11, nghttp3-devel >= 1.14.0, optionally jemalloc-devel
